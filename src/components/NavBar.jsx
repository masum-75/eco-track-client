      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <nav className="hidden md:flex gap-4 ml-6">
            ...
            <NavLink to="/my-activities" className={({isActive})=> isActive? 'text-pink-600 font-semibold' : ''}>My Activities</NavLink>
          </nav>
        </div>
        ...
        <div className="flex items-center gap-3">
          {user ? (
            <div className="flex items-center gap-3">
              ...
              <button onClick={()=>logout()} className="btn btn-sm bg-linear-to-r from-pink-500 to-red-600 text-white rounded-full">Logout</button>
            </div>
          ) : (
